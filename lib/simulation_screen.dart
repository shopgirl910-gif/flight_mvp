  ...
  Widget _buildOptimizerTab() {
    ...
    if (isAnonymous) {
      return Center(child: Padding(padding: const EdgeInsets.all(32), child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const Text('おまかせ最適化にはログインが必要です', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        Text('カード種別・ステータスを含めた正確な計算のため、\nプロフィール設定が必要です。', style: TextStyle(fontSize: 13, color: Colors.grey[600]), textAlign: TextAlign.center),
      ...
      return SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Wrap(spacing: 16, runSpacing: 12, children: [
                ...
                _optInputSection('運賃種別', 200, DropdownButton<String>(
                  ...
                  hint: const Text('運賃3 (75%) 相当', style: TextStyle(fontSize: 12, color: Colors.grey)),
          ...
          if (_optResults.isNotEmpty) ...[
            const SizedBox(height: 20),
            Text('検索結果（${_optResults.length}プラン）', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Align(alignment: Alignment.centerRight, child: TextButton.icon(
          ...
          label: const Text('自由設計に反映', style: TextStyle(fontSize: 12)),
